...
sealed class BookingUiEvent {
    ...
    data class DepartureDateSelected(val date: String) : BookingUiEvent()
    data class ReturnDateSelected(val departureDate: String,val endDate: String) : BookingUiEvent()
