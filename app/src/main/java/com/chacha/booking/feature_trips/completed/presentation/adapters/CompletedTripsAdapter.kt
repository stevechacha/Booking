package com.chacha.booking.feature_trips.completed.presentation.adapters
...
import com.chacha.booking.feature_trips.completed.domain.model.CompletedTrips

class CompletedTripsAdapter : ListAdapter<CompletedTrips, CompletedTripsAdapter.MyViewHolder>(MyDiffUtilCallback) {
